...
from algo.gwo.gwogoaha import gwogoaha
...
if __name__ == "__main__":
    ...
    for round in range(roundtime):
        ...
        fp = open(Round_txt, "a")
        fp.write("{}\n{}\n min : {} \n".format(round, np.array2string(result._get_convergence_list()),result._get_min_convergence_list()))
        fp.close()
